...
export const FALLBACK_TRANSACTIONS = withMultiples([
  mk('fb-1', 'Medtronic', 'Cardiac rhythm, surgical, and diabetes technologies.', 'Healthcare', 'North America', 'United States', 'US', '2025-04-10', 'Tencent', 'Strategic', 4500, 'USD', 600, 120, 3000),
  mk('fb-2', 'Stryker', 'Orthopedic implants and surgical equipment.', 'Healthcare', 'North America', 'United States', 'US', '2025-02-15', 'Silver Lake', 'Financial', 400, 'USD', 500, 200, 4000),
  mk('fb-3', 'Boston Scientific', 'Interventional cardiology and endoscopy devices.', 'Healthcare', 'North America', 'United States', 'US', '2024-12-05', 'Sequoia', 'Financial', 900, 'USD', 300, null, 3000),
  mk('fb-4', 'Edwards Lifesciences', 'Heart valves and hemodynamic monitoring.', 'Healthcare', 'Middle East & Africa', 'United Arab Emirates', 'AE', '2025-03-20', 'Mubadala', 'Financial', 60, 'USD', 100, null, 1500),
  mk('fb-5', 'Intuitive Surgical', 'Robotic-assisted surgical systems.', 'Healthcare', 'Asia Pacific', 'China', 'CN', '2025-01-12', 'General Atlantic', 'Financial', 110000, 'USD', 3000, 600, 6000),
  mk('fb-6', 'ResMed', 'Sleep apnea and respiratory care devices.', 'Healthcare', 'Europe', 'Sweden', 'SE', '2024-10-28', 'Sequoia', 'Financial', 5000, 'EUR', 1000, 100, 4000),
  mk('fb-7', 'Dexcom', 'Continuous glucose monitoring systems.', 'Healthcare', 'North America', 'United States', 'US', '2025-05-16', 'DST Global', 'Financial', 1300, 'USD', 800, null, 5000),
  mk('fb-8', 'Insulet', 'Wearable insulin pump systems.', 'Healthcare', 'North America', 'United States', 'US', '2025-06-22', 'SoftBank', 'Financial', 9000, 'USD', 2000, 200, 5000),
  mk('fb-9', 'Masimo', 'Noninvasive patient monitoring technologies.', 'Healthcare', 'North America', 'United States', 'US', '2024-09-09', 'Coatue', 'Financial', 800, 'USD', 300, 30, 1500),
  mk('fb-10', 'Penumbra', 'Neurovascular and thrombectomy devices.', 'Healthcare', 'North America', 'United States', 'US', '2025-03-12', 'Visa', 'Strategic', 1300, 'USD', 300, 60, 1800),
  mk('fb-11', 'Shockwave Medical', 'Intravascular lithotripsy for calcified arteries.', 'Healthcare', 'North America', 'United States', 'US', '2024-11-20', 'Greenoaks', 'Financial', 1200, 'USD', 320, null, 4800),
  mk('fb-12', 'Inari Medical', 'Venous thromboembolism removal devices.', 'Healthcare', 'North America', 'United States', 'US', '2025-04-03', 'Adobe', 'Strategic', 1500, 'USD', 900, 180, 4500),
  mk('fb-13', 'Axonics', 'Sacral neuromodulation therapy.', 'Healthcare', 'North America', 'United States', 'US', '2025-05-06', 'Founders Fund', 'Financial', 3000, 'USD', 1000, 320, 8000),
  mk('fb-14', 'iRhythm Technologies', 'Ambulatory cardiac monitoring and AI ECG.', 'Healthcare', 'North America', 'United States', 'US', '2025-03-10', 'Berkshire Hathaway', 'Strategic', 140000, 'USD', 3000, 600, 6000),
  mk('fb-15', 'Integra LifeSciences', 'Regenerative tissue and neurosurgery products.', 'Healthcare', 'North America', 'United States', 'US', '2025-05-02', 'Microsoft', 'Strategic', 3000, 'USD', 2000, null, 9000),
  mk('fb-16', 'Globus Medical', 'Musculoskeletal implants and surgical robotics.', 'Healthcare', 'Europe', 'Germany', 'DE', '2024-08-20', 'Robert Bosch Stiftung', 'Strategic', 100000, 'EUR', 3000, 360, 6000),
]);
